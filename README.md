...
![ logo](_images/comp_chem_karate2.png)
...
* ml - notebooks and data for trained DL models used for various purposes.
* qchem - quantum chem calculations.
* useful_scripts - generally useful miscellaneous Python scripts
