...
* All the parts of the scoring function for Reinvent like physchemm QED, etc. are termed **components** in the Reinvent world. Addition of the hERG ML model (or any model) to the scoring function necessitates writing your own component file to register and interact with the Reinvent workflow and make the prediction which is added to the output `.csv` (working examples can be found in `components/comp_herg.py` and `component/comp_logd.py`. 
