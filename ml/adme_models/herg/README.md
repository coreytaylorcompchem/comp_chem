...
The hERG model itself is a Graph Convolutional Network (GCN) deep learning classifier (0=inactive, 1=active @ 10 uM) with the following features implemented to improve training and prediction:
